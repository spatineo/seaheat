...
import { calculateDifference } from "../processing/util/calculateDifference"
...
startAppListening({
  ...
  effect: (_action, listenerApi) => {
    try {
      ...
      const output = calculateDifference(temperatureDischargeArrayValues, dischargeWaterTempArrayValues)
